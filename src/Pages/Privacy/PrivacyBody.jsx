      ...
      <div>
        ...
        <div>
          ...
          <ol className="md:pl-10 pl-5  font-PoppinsLight text14 text-[#b9b9b9]">
            ...
            <li className=" list-decimal">
              Financial Data: Payment details and transaction history for
              services provided.
            </li>
            <li className=" list-decimal">
              Technical Data: IP addresses, device information, browser type,
              and cookies to analyze website performance.
            </li>
            <li className=" list-decimal">
              Usage Data: Information about your interactions with our website,
              such as pages visited and time spent.
            </li>
          </ol>
        </div>
        ...
        <div>
          ...
          <ol className="md:pl-10 pl-5  font-PoppinsLight text14 text-[#b9b9b9]">
            ...
            <li className=" list-disc">
              Communicate updates, marketing offers, and service-related
              information.
            </li>
            <li className=" list-disc">
        ...
        <div>
          ...
          <ol className="md:pl-10 pl-5  font-PoppinsLight text14 text-[#b9b9b9]">
            ...
            <li className=" list-disc">
              Regulatory Bodies: When required for compliance or legal
              investigations.
            </li>
            <li className=" list-disc">
              Third-Party Vendors: Operating under strict confidentiality
              agreements.
            </li>
          </ol>
          <p className="text14  font-PoppinsLight text-[#b9b9b9]">
        ...
        <div>
          ...
          <ol className="md:pl-10 pl-5  font-PoppinsLight text14 text-[#b9b9b9]">
            ...
            <li className=" list-disc">
              Delete: Request erasure of your data under certain conditions.
            </li>
            <li className=" list-disc">
